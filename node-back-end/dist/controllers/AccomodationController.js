...
export class AccommodationController {
    static async createListing(req, res) {
        try {
            const { title, location, price, description, isAvailable, type, amenities, guests, bedrooms, bathrooms, reviews, rating, images, } = req.body;
    ...
    static async updateListing(req, res) {
        try {
            ...
            const updatedData = await Listing.findByIdAndUpdate(id, { $set: updateData }, { new: true });
            if (!updatedData) {
